...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", type=str, help="Model file path", default="disitllbert-base-uncased"
    )
    ...
    os.environ["WANDB_PROJECT"] = "ai-detector-text"
    ...
    # Train the model
    model = train_model(
        data, args.batch_size, args.epochs, args.learning_rate, args.device
    )
